...
class Profile extends React.Component{
    state={
        Avatar:"https://www.hdwallpaper.nu/wp-content/uploads/2016/01/zlatan_ibrahimovic_wallpaper_93590.png",
    }
    render(){
    return(
        <div>
            ...
            <div className="container-fluid !direction !spacing Contain">
                <div className="row ${1| ,row-cols-2,row-cols-3, auto,justify-content-md-center,|} rowOne">
                    ...
                    <a href="#" className="editP"> <img width="30" height="30" src={Gear}/> EditProfile</a>
                            ...
                            <div className="col-xl-4 col-lg-3 col-md-5 col-sm-12 col-xs-12">
